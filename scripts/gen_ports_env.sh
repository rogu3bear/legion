#!/usr/bin/env bash
# This script ensures that port environment variables are available.
# It relies on .env.ports having been generated by `python scripts/gen_env_ports.py legacy/ports.yaml > .env.ports.example`
# and then copied or sourced as .env.ports.
